			...
			local playerPed = GetPlayerPed(-1)
				if Config.MaxInService == -1 then
					ESX.Game.SpawnVehicle(model, {
						...
						SetVehicleNumberPlateText(vehicle," BIKER  “ .. numberplate .. ”")
...
Citizen.CreateThread(function()
    ...
    Wait(10)
		...
		if ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'biker' then
			local playerPed = GetPlayerPed(-1)
			local coords    = GetEntityCoords(playerPed)
			...
			for k,v in pairs(Config.BikerStations) do
				...
				if Config.EnablePlayerManagement and ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'biker' and ESX.PlayerData.job3.grade_name == 'boss' then
...
Citizen.CreateThread(function()
	...
	if CurrentAction ~= nil then
		...
		if IsControlJustReleased(0, 38) and ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'biker' then
        ...
        if CurrentAction == 'delete_vehicle' then
			...
			if Config.EnableSocietyOwnedVehicles then
				...
				if GetEntityModel(vehicle) == GetHashKey('BF400')  or GetEntityModel(vehicle) == GetHashKey('bati') or GetEntityModel(vehicle) == GetHashKey('chimera') or GetEntityModel(vehicle) == GetHashKey('speedo') then
		...
		if IsControlJustReleased(0, 56) and ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'biker' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'biker_actions') then

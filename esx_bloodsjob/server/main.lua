...
TriggerEvent('esx_society:registerProperty', 'bloods', 'Bloods', 'property_black_money_bloods', 'property_black_money_bloods', 'property_black_money_bloods', {type = 'public'})
...
ESX.RegisterServerCallback('esx_bloodsjob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'property_black_money_bloods', function(account)

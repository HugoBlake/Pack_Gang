...
TriggerEvent('esx_society:registerProperty', 'vagos', 'Vagos', 'property_black_money_vagos', 'property_black_money_vagos', 'property_black_money_vagos', {type = 'public'})
...
ESX.RegisterServerCallback('esx_vagosjob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'property_black_money_vagos', function(account)

...
function OpenCloakroomMenu()
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		elseif data.current.value == 'cartel_wear' then
			...
			local playerPed = GetPlayerPed(-1)
				if Config.MaxInService == -1 then
					ESX.Game.SpawnVehicle(model, {
						...
						SetVehicleNumberPlateText(vehicle," CARTEL “ .. numberplate .. ”")
...
Citizen.CreateThread(function()
    ...
    Wait(10)
		...
		if ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'cartel' then
			local playerPed = GetPlayerPed(-1)
			local coords    = GetEntityCoords(playerPed)
			...
			for k,v in pairs(Config.CartelStations) do
				...
				if Config.EnablePlayerManagement and ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'cartel' and ESX.PlayerData.job3.grade_name == 'boss' then
...
Citizen.CreateThread(function()
	...
	if CurrentAction ~= nil then
		...
		if IsControlJustReleased(0, 38) and ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'cartel' then
        ...
        if CurrentAction == 'delete_vehicle' then
			...
			if Config.EnableSocietyOwnedVehicles then
				...
				if GetEntityModel(vehicle) == GetHashKey('Kamacho')  or GetEntityModel(vehicle) == GetHashKey('Mesa') or GetEntityModel(vehicle) == GetHashKey('Rebel') or GetEntityModel(vehicle) == GetHashKey('speedo') then
		...
		if IsControlJustReleased(0, 56) and ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'cartel' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'cartel_actions') then

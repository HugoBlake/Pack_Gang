...
TriggerEvent('esx_society:registerProperty', 'cartel', 'Cartel', 'property_black_money_cartel', 'property_black_money_cartel', 'property_black_money_cartel', {type = 'public'})
...
ESX.RegisterServerCallback('esx_carteljob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'property_black_money_cartel', function(account)

...
Citizen.CreateThread(function()
    ...
    Wait(10)
		...
		if ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'mafia' then
			local playerPed = GetPlayerPed(-1)
			local coords    = GetEntityCoords(playerPed)
			...
			for k,v in pairs(Config.MafiaStations) do
				...
				if Config.EnablePlayerManagement and ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'mafia' and ESX.PlayerData.job3.grade_name == 'boss' then
...
Citizen.CreateThread(function()
	...
	if CurrentAction ~= nil then
		...
		if IsControlJustReleased(0, 38) and ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'mafia' then
		...
		if IsControlJustReleased(0, 56) and ESX.PlayerData.job3 ~= nil and ESX.PlayerData.job3.name == 'mafia' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') then

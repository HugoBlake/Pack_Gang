...
TriggerEvent('esx_society:registerProperty', 'mafia', 'Mafia', 'property_black_money_mafia', 'property_black_money_mafia', 'property_black_money_mafia', {type = 'public'})
...
ESX.RegisterServerCallback('esx_mafiajob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'property_black_money_mafia', function(account)
